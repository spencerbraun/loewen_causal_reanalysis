...
Table 1
```{r}
lm(current_vote ~ govp2p + gov + p2p + previous_vote + y2006, data= main)
```
...
Matches our stata output, see Stata-MainResult.png. However p-values remain slightly different despite equal counts, hard to tell what else could be the reason besides different software defaults?
```{r}
